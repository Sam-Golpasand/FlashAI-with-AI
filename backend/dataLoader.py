...
from query_data import generate_questions
from send_data import split_output
import asyncio
...
async def add_to_chroma(chunks: list[Document]):
    ...
    if len(new_chunks) > 0:
        print(f"Adding new documents. chunks count: {len(new_chunks)}")
...
def calculate_chunk_ids(chunks):
    ...
    # This will create IDs like "data/sample.pdf:6:2"
